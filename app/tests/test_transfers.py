...
class TestTranfer(unittest.TestCase):
    personal_data = {
        "name": "Dariusz",
        "surname": "Januszewski",
        "pesel": "03245678901" 
    ...
    def test_incoming_transfer(self):
        account = PersonalAccount(self.personal_data["name"], self.personal_data["surname"], self.personal_data["pesel"])
    ...
    def test_outgoing_transfer_with_promo_code(self):
        account = PersonalAccount(self.personal_data["name"], self.personal_data["surname"], self.personal_data["pesel"], "PROM_123")
    ...
    #     account = Konto(self.personal_data["name"], self.personal_data["surname"], self.personal_data["pesel"])